export const resolvers = { Query:  {
          ...
          Condition: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/lists/1/rules/1/conditions?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          ConnectedPerson: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people/1/connected_people?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          FieldOption: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/field_definitions/1/field_options?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          FormField: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/forms/1/fields?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          FormFieldOption: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/forms/1/fields/1/options?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          FormSubmission: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/forms/1/form_submissions?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          FormSubmissionValue: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/forms/1/form_submissions/1/form_submission_values?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          HouseholdMembership: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/households/1/household_memberships?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          ListResult: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/lists/1/list_results?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          ListShare: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/lists/1/shares?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          ListStar: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/lists/1/star?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          MailchimpSyncStatus: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/lists/1/mailchimp_sync_status?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          NoteCategoryShare: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/note_categories/1/shares?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          Organization: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          PeopleImportConflict: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people_imports/1/conflicts?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          PeopleImportHistory: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people_imports/1/histories?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          PersonApp: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people/1/person_apps?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          PlatformNotification: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people/1/platform_notifications?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          Rule: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/lists/1/rules?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          ServiceTime: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/campuses/1/service_times?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          WorkflowCard: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people/1/workflow_cards?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          WorkflowCardActivity: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people/1/workflow_cards/1/activities?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          WorkflowCardNote: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people/1/workflow_cards/1/notes?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          WorkflowCategory: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/workflow_categories?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          WorkflowShare: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/people/1/workflow_shares?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          WorkflowStep: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/workflows/1/steps?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
          ...
          WorkflowStepAssigneeSummary: async (parent, params, context, info) => {
            ...
            let response = await getJSONfromUrl(`https://api.planningcenteronline.com/people/v2/workflows/1/steps/1/assignee_summaries?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
              {
                method: "GET",
                headers: {
                  Authorization:
