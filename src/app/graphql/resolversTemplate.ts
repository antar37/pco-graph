  ...
  Query: {
    CalendarAttachment: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/attachments?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarConflict: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/conflicts?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarEvent: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/events?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarEventInstance: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/event_instances?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarEventResourceRequest: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/event_resource_requests?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarFeed: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/feeds?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarPerson: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/people?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarReportTemplate: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/report_templates?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarResource: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/resources?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarResourceApprovalGroup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/resource_approval_groups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarResourceBooking: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/resource_bookings?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarResourceFolder: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/resource_folders?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarResourceQuestion: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/resource_questions?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarRoomSetup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/room_setups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarTag: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/tags?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    CalendarTagGroup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/calendar/v2/tag_groups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insCheckIn: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/check_ins?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insEvent: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/events?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insEventTime: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/event_times?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insHeadcount: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/headcounts?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insLabel: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/labels?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insOption: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/options?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insPass: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/passes?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insPerson: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/people?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insStation: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/stations?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    Check_insTheme: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/check_ins/v2/themes?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GroupsEvent: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/groups/v2/events?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GroupsGroup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/groups/v2/groups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GroupsGroupType: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/groups/v2/group_types?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GroupsPerson: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/groups/v2/people?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GroupsTagGroup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/groups/v2/tag_groups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesAttachmentType: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/attachment_types?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesChat: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/chats?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesEmailTemplate: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/email_templates?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesFolder: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/folders?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesMedia: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/media?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesOrganization: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesPerson: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/people?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesReportTemplate: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/report_templates?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesSeries: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/series?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesServiceType: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/service_types?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesSong: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/songs?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesTagGroup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/tag_groups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ServicesTeam: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/services/v2/teams?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesAttachment: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/attachments?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesConflict: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/conflicts?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesEvent: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/events?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesEventInstance: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/event_instances?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesEventResourceRequest: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/event_resource_requests?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesFeed: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/feeds?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesPerson: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/people?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesReportTemplate: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/report_templates?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesResource: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/resources?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesResourceApprovalGroup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/resource_approval_groups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesResourceBooking: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/resource_bookings?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesResourceFolder: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/resource_folders?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesResourceQuestion: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/resource_questions?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesRoomSetup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/room_setups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesTag: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/tags?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    ResourcesTagGroup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/resources/v2/tag_groups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingBatch: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/batches?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingBatchGroup: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/batch_groups?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingCampus: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/campuses?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingDonation: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/donations?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingFund: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/funds?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingLabel: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/labels?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingPaymentSource: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/payment_sources?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingPerson: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/people?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
    ...
    GivingRecurringDonation: async (
      ...
      let response = await getJSONfromUrl(
        `https://api.planningcenteronline.com/giving/v2/recurring_donations?per_page=${limit}&include=${includes}${whereArg}${orderArg}`,
        {
          method: "GET",
          headers: {
            Authorization:
